...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/jquerythailand/dist/jquery.Thailand.min.css')?>">
...
<script type="text/javascript" src="<?php echo base_url('assets/jquerythailand/dependencies/zip.js/zip.js');?>"></script>
<!-- / dependencies for zip mode -->

<script type="text/javascript" src="<?php echo base_url('assets/jquerythailand/dependencies/JQL.min.js')?>"></script>
<script type="text/javascript" src="<?php echo base_url('assets/jquerythailand/dependencies/typeahead.bundle.js')?>"></script>

<script type="text/javascript" src="<?php echo base_url('assets/jquerythailand/dist/jquery.Thailand.min.js')?>"></script>
...
<script type="text/javascript">
    ...
    // for more info check README.md
    $.Thailand({
        database: '../assets/jquerythailand/database/db.zip',

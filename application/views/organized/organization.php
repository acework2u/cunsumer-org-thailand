    ...
    <div id="register" class="register p-relative">
        <div class="container container-lg">
            ...
            <div class="form-header text-center d-block d-sm-none">
                <h1 class="mb-0 pt-4">ลงทะเบียนสมาชิกองค์กรผู้บริโภค</h1>
                ...
                <div class="location-sm d-block d-lg-none">
                    <div class="swiper-container">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide location-container" v-for="item , index in filterOrzList">
                                <div class="row m-auto h-100" @click="userClick(item)">

...
<head>
    ...
    <title>Thailand consumer council | Dashboard</title>
...
<!--   <link rel="stylesheet" href="--><?php //echo base_url('assets/css/uikit.css')?><!--">-->
    ...
    <script src="<?php echo base_url('assets/js/bootstrap-vue.min.js')?>"></script>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span class="hidden-xs"><?php echo getUserFirstName()." ".getUserLastName();?></span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->

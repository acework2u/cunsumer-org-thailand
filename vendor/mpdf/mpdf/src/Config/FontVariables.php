...
class FontVariables
{
	...
	public function __construct()
	{
		$this->defaults = [
			...
			'sans_fonts' => ['dejavusanscondensed', 'sans', 'sans-serif', 'cursive', 'fantasy', 'dejavusans','thsarabunnew', 'freesans', 'liberationsans',
			...
			'serif_fonts' => ['dejavuserifcondensed', 'serif', 'dejavuserif','thsarabunnew', 'freeserif', 'liberationserif',
